      ...
      <div className="grid-rows-span-full justify-center pt-60 z-10">
        <div className="flex justify-center">
          <div className="flex flex-row justify-right pt-40">
            <div className="relative w-[533px] h-[187px] [font-family:'Inter',Helvetica] font-black text-black text-[48px]">
              Online learning &amp; <br />
              Teaching Platform
          ...
          <div className="flex flex-col justify-right">
            <div className="relative w-[600px] h-[500px] -top-px -left-px bg-white rounded-[5px] border border-solid border-[#192655]">
              <p className="absolute top-[340px] left-[220px] [font-family:'Inter',Helvetica] font-normal text-transparent text-[16px]">
              ...
              <div className="absolute w-[470px] h-[40px] top-[220px] left-[70px]">
                <div className="relative w-[460px] h-[40px] bg-[#d9d9d9] rounded-[5px]">
                  <input type="password" className="w-full h-full px-4 py-2 [font-family:'Inter',Helvetica] font-semibold text-[#797878] text-[16px] bg-slate-200" placeholder="Enter Password"/>
                </div>
              </div>
              <button className="absolute w-[250px] h-[40px] top-[290px] left-[180px] box-border">
                <div className="relative w-[250px] h-[40px] bg-[#192655] rounded-[5px]">
                  <div className="absolute w-[70px] top-[2px] left-[90px] [font-family:'Inter',Helvetica] font-semibold text-white text-[24px]">
                    Login
                  </div>
                </div>
              </button>
              <button className="absolute w-[460px] h-[60px] top-[380px] left-[70px] border-2 border-solid border-[#192655] rounded-[5px]">
                <div className="relative w-[250px] left-[110px] [font-family:'Inter',Helvetica] font-semibold text-[#192655] text-[32px]">
                  Create Account
                </div>
              </button>
              <div className="absolute top-[70px] left-[70px] [font-family:'Inter',Helvetica] font-bold text-[#192655] text-[40px]">
                Login
              </div>
            </div>
          </div>
