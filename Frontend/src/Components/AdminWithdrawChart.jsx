...
const adminWithdrawCart = async () => {
  return axios.get("http://localhost:3000/AdminWithdarwHistory", {
    withCredentials: true,
  });
};

async function updateReqStatus(reqId,reqStatus) {
  const data = await axios.get(`http://localhost:3000/updateWithdrawStatus?id=${reqId}&status=${reqStatus}`,{
    withCredentials: true,
  })
  alert(data.data.message);
}

const AdminWithdrawChart = () => {
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap px-6 py-4">
                          <button
                            ...
                            onClick={() => updateReqStatus(item.w_id,reqStatus)}
                          >
                            Update Status
                          </button>
                        </td>
...
export default AdminWithdrawChart;
